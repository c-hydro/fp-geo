...
#import hmc_apps_dataland_flowdirections as oFDir
#import hmc_apps_dataland_drainagearea as oDArea
#import hmc_apps_dataland_channelsnetwork as oCNet
#import hmc_apps_dataland_watertableslopes as oWSlope
#import hmc_apps_dataland_coeffresolution as oCRes
#import hmc_apps_dataland_corrivationtime as oCTime

import Lib_HMC_DataLand_FlowDirections as oFDir
import Lib_HMC_DataLand_DrainageArea as oDArea
import Lib_HMC_DataLand_ChannelsNetwork as oCNet
import Lib_HMC_DataLand_WatertableSlopes as oWSlope
import Lib_HMC_DataLand_CoeffResolution as oCRes
import Lib_HMC_DataLand_CorrivationTime as oCTime
#######################################################################################
...
def computeFlowDirections(a2dVarDEM, oMPDict=None):
    ...
    if oMPDict is None:
        ...
        oMPDict['PNT'] = a2iVarPNT

# -------------------------------------------------------------------------------------

# -------------------------------------------------------------------------------------
# Method to compute drainage area (using fortran external source)
def computeDrainageArea(a2dVarDEM, a2iVarPNT, oMPDict=None):
    ...
    if oMPDict is None:
        ...
        oMPDict['DAREA'] = a2iVarDAREA
# -------------------------------------------------------------------------------------

# -------------------------------------------------------------------------------------
# Method to compute channels network (using fortran external source)
def computeChannelsNetwork(a2dVarDEM, a2iVarPNT, a2iVarDAREA, dVarAvgCAREA, dParCNET, oMPDict=None):
    ...
    if oMPDict is None:
        ...
        oMPDict['CNET'] = a2iVarCNET
        oMPDict['PDIST'] = a2dVarPDIST

# -------------------------------------------------------------------------------------

# -------------------------------------------------------------------------------------
# Method to compute watertable slopes (using fortran external source)
def computeWatertableSlopes(a2dVarDEM, a2iVarPNT, a2iVarCNET, a2dVarCAREA, dParWT, oMPDict=None):
    ...
    if oMPDict is None:
        ...
        oMPDict['ALPHA'] = a2dVarALPHA
        oMPDict['BETA'] = a2dVarBETA
...
def computeCorrivationTime(a2dVarDEM, a2iVarPNT, a2dVarPDIST, a2iVarCNET, a2dVarUH, a2dVarUC,
                           iSecJout, iSecIout, iSEC_HydID=1, oMPDict=None):
    ...
    if oMPDict is None:
        ...
        oMPDict['CTIME'] = a2dVarCTIME
        oMPDict['MASK'] = a2iVarMASK
        oMPDict['DEMMASKED'] = a2dVarDEMMASKED

# -------------------------------------------------------------------------------------

# -------------------------------------------------------------------------------------
# Method to compute coefficient resolution (using fortran external source)
def computeCoeffResolution(a2dVarDEM, a2iVarDAREA, a2iVarCNET, a2dVarCAREA, dParCR, oMPDict=None):
